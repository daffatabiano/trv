...
export const Card = React.memo(
  ({ card, index, hovered, setHovered, variant, slug }) => {
    ...
    return (
      <div
        onClick={() => push(`/dashboard/${slug}/${card.id}`)}
        ...
        <Image
          src={card.imageUrl || card?.imageUrls[0]}
...
export function FocusCards({ cards, variant, sorting, slug }) {
