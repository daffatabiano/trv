    ...
    <div className="bg-slate-900/60 max-w-screen w-full h-full md:min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="w-full h-full sm:w-4/5 lg:w-2/3 flex flex-col gap-2 items-center justify-center p-5">
        ...
        <Form onSubmit={handleRegister}>
          ...
          <button
            type="submit"
            className="w-full bg-amber-300 hover:bg-amber-400 hover:translate-y-1 hover:shadow-inner hover:shadow-amber-600 rounded-full px-4 py-2 sm:w-1/2 sm:mx-auto text-white font-bold">
            Register
          </button>
        </Form>
        <div>
          <p className="text-white text-sm font-thin">
            ...
            <Link href="/auth/login" className="text-amber-300 font-normal">
              Sign In
            </Link>
          </p>
        </div>
